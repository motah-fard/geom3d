...
// for Go.
//
// It includes vectors, planes, rays, segments, triangles, axis-aligned and
// oriented bounding boxes, spheres, rotation matrices, quaternions, rigid
// transforms, and common operations such as distances, projections,
// closest-point queries, and intersections.
//
...
//     abs/min/max
//   - Geometry primitives: Ray3, Segment3, Plane, Triangle, AABB, Sphere, OBB
...
//     box queries, sphere queries, OBB queries, ray-plane intersection,
//     ray-triangle intersection, ray-sphere intersection, segment-plane
